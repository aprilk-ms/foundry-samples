...
| 14  | [Evaluation](responses/14-evaluation/)                                     | Evaluate a deployed hosted agent end-to-end: **Adaptive Evaluator** ⭐ (primary recommended path) and red-team / safety, plus built-in single- and multi-turn evaluators, dataset generation from traces / synthetic seeds, and scheduled / continuous evaluation. |
