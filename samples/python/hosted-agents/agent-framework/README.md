...
| 14  | [Evaluation](responses/14-evaluation/)                                     | Evaluate a deployed hosted agent end-to-end: **Custom Rubric Evaluator** ⭐ (recommended starting point) and red-team / safety, plus built-in single- and multi-turn evaluators, dataset generation from traces / synthetic seeds, and scheduled / continuous evaluation. |
